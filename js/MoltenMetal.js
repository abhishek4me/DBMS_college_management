...
function mountMoltenMetal() {
  const mountTarget = document.getElementById('molten-metal-root');
  if (mountTarget && window.ReactDOM) {
    const root = window.ReactDOM.createRoot(mountTarget);
    root.render(
      h(MoltenMetal, {
        color1: '#3b0764',
        color2: '#6b1426',
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', mountMoltenMetal);
} else {
  mountMoltenMetal();
}
